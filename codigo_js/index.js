...
function agregarFarmacias() {
    var listado = farmacias.map(function(farmacia, index) {
        ...
        var whatsapp = farmacia.whatsapp ? `<p> <a href="tel:+54 ${farmacia.whatsapp}" class="farmacias_numero">Whatsapp: ${farmacia.whatsapp}<br> </a></p>` : "";
        ...
        if(index == 0) {
            return `<div class="filterDiv farma ${cardStyle} ${localidad} principal">
                        <div class="text-center">
                            ...
                            <p> <a href="tel:+54 ${farmacia.whatsapp}" class="farmacias_numero prm"> Whatsapp: ${farmacia.whatsapp}<br></a></p>
